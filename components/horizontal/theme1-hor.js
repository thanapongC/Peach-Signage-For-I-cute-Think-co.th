...
class Theme1ScreenHor extends React.Component {
                 ...
                 const temIDvalue = await AsyncStorage.getItem('Template_id');
                   ...
                   console.log(responseJson)
                    ...
                    if(responseJson == '1'){
                      ...
                      await AsyncStorage.removeItem('Text_Content');
...
async componentDidMount(){
  ...
  setTimeout(() => {
    ...
    return (
      ...
      <View style={{ flex: 1 , flexDirection: 'row', justifyContent: 'center', zIndex: 2 }}>
      ...
      <View style={{ flex: 3.5, backgroundColor: 'black', zIndex: 3 }}>
      ...
      <View style={{ flex: 1, backgroundColor: 'black' }}>
            ...
            <MarqueeLabel style={{ marginLeft: 20, zIndex: 'auto' }}
              duration={9000}
...
export default createSwitchNavigator(
  {
    Theme1ScreenHorPage: { screen: Theme1ScreenHor },
  }
);
