...
import ReadPicItemPagehor1 from '../readimg/readimghor1';
...
class LoadingHor1 extends React.Component {
...
get_data = async () => {
       ...
       try {
         ...
         let response = await fetch(url + 'php/api/getdataall.php', option )
                 ...
                 this.setState({
                   ...
                   image_type: responseJson.image_type_1,
    ...
    setTimeout(() => {
    this.props.navigation.navigate('ReadPicItemPagehor1Route');
...
export default createSwitchNavigator(
  {
    LoadingHor1Page: { screen: LoadingHor1 },
    ReadPicItemPagehor1Route: { screen: ReadPicItemPagehor1 },
  }
);
