...
import ReadPicItemPagehor2 from '../readimg/readimghor2';
...
class LoadingHor2 extends React.Component {
...
async componentDidMount(){
    ...
    setTimeout(() => {
      ...
      this.props.navigation.navigate('ReadPicItemPagehor2Route');
...
export default createSwitchNavigator(
  {
    ...
    LoadingHor2Page: { screen: LoadingHor2 },
    ReadPicItemPagehor2Route: { screen: ReadPicItemPagehor2 },
