...
import ReadPicItemPagever5 from '../readimg/readimgver5';
...
class LoadingVer5 extends React.Component {
...
get_data = async () => {
    ...
    setTimeout(() => {
      ...
      this.props.navigation.navigate('ReadPicItemPagever5Route');
...
export default createSwitchNavigator(
  {
    LoadingVer5Page: { screen: LoadingVer5 },
    ReadPicItemPagever5Route: { screen: ReadPicItemPagever5 },
  }
);
