...
import Theme1ScreenHorPage from '../horizontal/theme1-hor';
import * as Progress from 'react-native-progress';

const { config, fs } = RNFetchBlob;

class ReadPicItemhor1 extends React.Component {
  ...
  read_Pic_Item = async () => {
    ...
    this.props.navigation.navigate('Theme1ScreenHorPageRoute');
...
export default createSwitchNavigator(
  {
    ReadPicItemPagehor1: { screen: ReadPicItemhor1 },
    Theme1ScreenHorPageRoute: { screen: Theme1ScreenHorPage },
  }
);
