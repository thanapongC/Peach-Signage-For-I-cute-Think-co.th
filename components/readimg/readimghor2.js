...
import Theme2ScreenHorPage from '../horizontal/theme2-hor';
import * as Progress from 'react-native-progress';

const { config, fs } = RNFetchBlob;

class ReadPicItemhor2 extends React.Component {
  ...
  constructor(props){
    ...
    setTimeout(() => {
      ...
      this.props.navigation.navigate('Theme2ScreenHorPageRoute');
...
export default createSwitchNavigator(
  {
    ReadPicItemPagehor2: { screen: ReadPicItemhor2 },
    Theme2ScreenHorPageRoute: { screen: Theme2ScreenHorPage },
  }
);
