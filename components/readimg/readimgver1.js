...
import Theme1ScreenVerPage from '../vertical/theme1-ver';
import * as Progress from 'react-native-progress';

const { config, fs } = RNFetchBlob;

class ReadPicItemver1 extends React.Component {
  ...
  read_Pic_Item = async () => {
    ...
    // setTimeout(() => {
      ...
      this.props.navigation.navigate('Theme1ScreenVerPageRoute');
...
export default createSwitchNavigator(
  {
    ReadPicItemPagever1: { screen: ReadPicItemver1 },
    Theme1ScreenVerPageRoute: { screen: Theme1ScreenVerPage },
  }
);
